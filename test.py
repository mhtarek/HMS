...
def mainroot():
    ...
    root.title("Made with love by MH")
    # --------------seperator------------------------------------------------------------------------------------------
    ...
    def hotel_status():
        ...
        # hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhheeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeerrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr
        ...
        # -----------------------------------------------------------------
        nl = Label(b_frame, text='Made by MH', fg='black', bg='gray91', font='msserif 8')
    ...
    def staff():
        ...
        Label(emp1inf, text="Customer Executive", bg='white', font='msserif 17 bold').place(x=45,
                                                                                            y=0)  # pack(side='top')
    ...
    def payments():
        ...
        label.image = img
        label.place(x=0, y=0)
        l = Label(b_frame, text='Please Enter The Unique Payment ID', font='msserif 10', bg='cyan4', fg='white')
        l.place(x=450, y=0)
        b_frame.place(x=0, y=120 + 6 + 20 + 60 + 11)
        b_frame.pack_propagate(False)
        b_frame.tkraise()
    ...
    def login():
        def command1():
            if username.get() == "user" and password.get() == "password":  # Checks whether username and password are correct
        ...
        # ==============================LABELS=========================================
        lbl_title = Label(Top, text="Welcome to the Heaven hotel", font=('arial', 15))
        ...
        # ==============================BUTTON WIDGETS=================================
        btn_login = Button(Form, text="Login", width=45,command=lambda:command1())
