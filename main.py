...
cur.execute(
    "create table if not exists roomd(rn number primary key,beds number,ac varchar(10),tv varchar(10),internet varchar(10),price number(10))")
...
sroot.minsize(height=864, width=1296)
...
my.image = simg
my.place(x=0, y=0)
Frame(sroot, height=516, width=10, bg='red').place(x=450, y=0 + 320)
# chilanka
Label(sroot, text="Hotel Management System ", font='Timesnewroman 40 ', bg='white', fg='black').place(x=475, y=10 + 320)
Label(sroot, text="Made by - MH Tarek", font='Timesnewroman 25 ', bg='white', fg='black').place(x=475, y=150 + 320)
# Label(sroot, text="MH", font='Timesnewroman 40 ', bg='white', fg='grey').place(x=475, y=180+320)
Label(sroot, text="mhtarek1995@gmail.com", font='Timesnewroman 25', bg='white', fg='grey').place(x=475, y=220 + 320)
...
def mainroot():
    ...
    root.minsize(width=1080, height=650)
    root.maxsize(width=1080, height=650)
    root.configure(bg='white')
    root.title("Made by MH and Soumik")
    # --------------seperator------------------------------------------------------------------------------------------

    sep = Frame(height=500, bd=1, relief='sunken', bg='red')
    ...
    def datetime():
        ...
        lblInfo = Label(top_frame, font='helvetica 12', text=localtime, bg='gray91', fg='red')

        lblInfo.place(x=900, y=40)
    ...
    def hotel_status():
        ...
        print(y)
        tor = x[0]  # total rooms
        rer = y[0]  # reserved rooms
        tos = 21  # total staff
        avr = int(tor) - int(rer)  # available rooms
        avr = str(avr)
        ...
        tr = Label(smf1, text='Total Rooms:', fg='white', bg='cyan4', width=100, height=2, font='helvetica 12')
        tr.pack(side='top')
        ...
        ar = Label(smf2, text='Available Rooms:', fg='white', bg='cyan4', width=130, height=2, font='helvetica 12')
        ar.pack(side='top')
        ...
        tre = Label(smf3, text='Total reservations:', fg='white', bg='cyan4', width=130, height=2, font='helvetica 12')
        tre.pack(side='top')
        ...
        tc = Label(smf4, text='Total Customers:', fg='white', bg='cyan4', width=130, height=2, font='helvetica 12')
        tc.pack(side='top')
        ...
        ts = Label(smf5, text='Total Staff:', fg='white', bg='cyan4', width=130, height=2, font='helvetica 12')
        ts.pack(side='top')
        ...
        ts = Label(smf6, text='Under renovation:', fg='white', bg='cyan4', width=130, height=2, font='helvetica 12')
        ts.pack(side='top')
        ...
        # -----------------------------------------------------------------
        nl = Label(b_frame, text='Made by MH and Soumik', fg='black', bg='gray91', font='msserif 8')
        nl.place(x=900, y=380)
        nl.tkraise()
    ...
    def staff():
        ...
        Label(emp1inf, text="Manager", bg='white', font='msserif 15 bold').place(x=60, y=0)
        Label(emp1inf, text="Md. Mosabbir Hossain", bg='white', fg="Grey", font='msserif 10').place(x=60, y=37)
        Label(emp1inf, text="Extention : 025", bg='white', fg="Grey", font='msserif 10').place(x=60, y=59)
        Label(emp1inf, text="Mail : mhtarek@gmail.com", bg='white', fg="Grey", font='msserif 10').place(x=60, y=83)
        ...
        Label(emp1inf, text="Customer Executive", bg='white', font='msserif 15 bold').place(x=45,
                                                                                            y=0)  # pack(side='top')
        Label(emp1inf, text="Md. Eliyas Khan", bg='white', fg="Grey", font='msserif 10').place(x=45, y=37)
        Label(emp1inf, text="Extention : 032", bg='white', fg="Grey", font='msserif 10').place(x=45, y=59)
        Label(emp1inf, text="Mail : eliyas@gmail.com", bg='white', fg="Grey", font='msserif 10').place(x=45, y=83)
        emp1inf.pack_propagate(False)
        ...
        Label(emp1inf, text="Restaurant", bg='white', font='msserif 15 bold').place(x=72, y=0)  # pack(side='top')
        Label(emp1inf, text="Md. Sayan", bg='white', fg="Grey", font='msserif 10').place(x=72, y=37)
        Label(emp1inf, text="Extention : 028", bg='white', fg="Grey", font='msserif 10').place(x=72, y=59)
        Label(emp1inf, text="Mail : sayanvai@gmail.com", bg='white', fg="Grey", font='msserif 10').place(x=72,
                                                                                                               y=83)
        emp1inf.pack_propagate(False)
        ...
        Label(emp1inf, text="Room Service", bg='white', font='msserif 15 bold').place(x=55, y=0)  # pack(side='top')
        Label(emp1inf, text="Md. Shahariar Sardar", bg='white', fg="Grey", font='msserif 10').place(x=55, y=37)
        Label(emp1inf, text="Extention : 041", bg='white', fg="Grey", font='msserif 10').place(x=55, y=59)
        Label(emp1inf, text="Mail : shahariar@gmail.com", bg='white', fg="Grey", font='msserif 10').place(x=55,
                                                                                                              y=83)
        emp1inf.pack_propagate(False)
    ...
    def rooms():
        ...
        def roomdet(rno):
            Label(b_frame, text='Room %s' % rno, font='msserif 10', fg='white', bg='cyan4', width=10).place(x=535, y=0)
            ...
            tr = Label(smf1, text='Total Bed(s):', fg='white', bg='cyan4', width=100, height=2, font='msserif 12')
            tr.pack(side='top')
            smf1.pack_propagate(False)
        ...
        b11 = Button(b_frame, font='mssherif 10', text="Room 11", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(11))
        b12 = Button(b_frame, font='mssherif 10', text="Room 12", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(12))
        b13 = Button(b_frame, font='mssherif 10', text="Room 13", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(13))
        b14 = Button(b_frame, font='mssherif 10', text="Room 14", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(14))
        b15 = Button(b_frame, font='mssherif 10', text="Room 15", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(15))
        b16 = Button(b_frame, font='mssherif 10', text="Room 16", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(16))
        b17 = Button(b_frame, font='mssherif 10', text="Room 17", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(17))
        b18 = Button(b_frame, font='mssherif 10', text="Room 18", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(18))
        b19 = Button(b_frame, font='mssherif 10', text="Room 19", bg='white', fg='cyan4', width=10,
                     command=lambda: roomdet(19))
        b20 = Button(b_frame, font='mssherif 10', text="Room 20", bg='white', fg='cyan4', width=10,
    ...
    def payments():
        ...
        label.image = img
        label.place(x=0, y=0)
        l = Label(b_frame, text='Please Enter The Payment ID', font='msserif 10', bg='cyan4', fg='white')
        l.place(x=450, y=0)
        b_frame.place(x=0, y=120 + 6 + 20 + 60 + 11)
        b_frame.pack_propagate(False)
        b_frame.tkraise()
        ...
        def getid(event=None):
            ...
            fl4.place(x=0, y=191)
            fl4.pack_propagate(False)
            l1 = Label(fl4, text='Room Number', bg='cyan4', fg='white', font='msserif 17')
            l1.pack()
            ...
            if (yy != None):
                ...
                l4 = Label(fr4, text=roomNumber, height=38, width=1080 - 308, font='msserif 15', bg='white', fg='cyan4').pack()
            else:
                ...
                l1 = Label(fr3, text='No Information Available', height=38, width=1080 - 308, font='msserif 15',
                           bg='white', fg='cyan4').pack()
                l1 = Label(fr4, text='No Information Available', height=38, width=1080 - 308, font='msserif 15',
                           bg='white', fg='cyan4').pack()
    ...
    def reserve():
        ...
        def booking():
            ...
            # cur.execute("create table if not exists paymentsf(id number  primary key,f_name varchar,l_name varchar,c_number varchar,email varchar , r_n number ,day varchar,month varchar,year varchar,time varchar , method varchar)")
                ...
                if temp[0] == 'Reserved':
                    ...
                    def f():
                        if pmethod.get() != '':
                            ...
                            if ask == True:
                                ...
                                totalCost = str(int(rp[0]) * int(nod.get()))

                                fl = open("reciept.txt", "w")
                                fl.write("Bill ID: {}\n".format(cid))
                                fl.write("Name: {} {}\n".format(fn.get(), ln.get()))
                                fl.write("Contact: {}\n".format(cn.get()))
                                fl.write("Number of Days: {}\n".format(nod.get()))
                                fl.write("Total Cost: {}\n".format(totalCost))
                    ...
                    Label(payroot, text='Select an option to pay ' + str(int(rp[0]) * int(nod.get())),
                          font='msserif 14 bold', bg='White').place(x=0, y=0)
                    Frame(payroot, height=4, width=300, bg='cyan4').place(x=0, y=39)
                    Radiobutton(payroot, text='Cash  ', bg='White', variable=pmethod, value=0, font='helvetica 15',
                                width=5).place(x=0, y=43 + 10)

                    Radiobutton(payroot, text='Card   ', bg='White', variable=pmethod, value=1, font='helvetica 15',
                                width=5, state=DISABLED).place(x=0, y=80 + 10)
                    Radiobutton(payroot, text='UPI     ', bg='White', variable=pmethod, value=2, font='helvetica 15',
                                width=5, state=DISABLED).place(x=0, y=115 + 10)
                    Radiobutton(payroot, text='Paytm ', bg='White', variable=pmethod, value=3, font='helvetica 15',
                                width=5, state=DISABLED).place(x=0, y=150 + 10)


                    Button(payroot, text='Pay', font='msserif 12', bg='Green', fg='White', width=28, command=f).place(
                        x=0, y=200)
        ...
        Res = Button(b_frame, text='Reserve', bg='white', fg='cyan4', font='timenewroman 11', activebackground='green',
                     command=booking).place(x=235, y=270)
        unres = Button(b_frame, text='Unreserve', bg='white', fg='cyan4', font='timenewroman 11',
                       activebackground='green', command=unreserve).place(x=327, y=270)
        findrooms = Button(b_frame, text='Find Rooms', bg='white', fg='cyan4', font='timenewroman 9',
    ...
    def login():
        def command1():
            usernameList = ['admin','tarek','soumik','a']
            passwordList = ['admin','tarek','soumik','a']

            index = usernameList.index(username.get())

            if username.get() in usernameList and password.get() == passwordList[index]:  # Checks whether username and password are correct
                root.deiconify()  # Unhides the root window
                lgroot.destroy()  # Removes the toplevel window
            else:
        ...
        width = 600
        height = 380
        screen_width = lgroot.winfo_screenwidth()
        screen_height = lgroot.winfo_screenheight()
        x = (screen_width / 2) - (width / 2)
        y = (screen_height / 2) - (height / 2)
        lgroot.geometry("%dx%d+%d+%d" % (width, height, x, y))
        lgroot.resizable(0, 0)
        # ==============================VARIABLES======================================
        ...
        # ==============================FRAMES=========================================
        Top = Frame(lgroot, bd=2, relief=RIDGE)
        Top.pack(side=TOP, fill=X)
        Form = Frame(lgroot, height=200)
        Form.pack(side=TOP, pady=20)

        # ==============================LABELS=========================================
        lbl_title = Label(Top, text="Welcome to the Heaven hotel", font=('arial', 20, "bold"), fg = "red")
        ...
        username = ttk.Entry(Form, textvariable=USERNAME, font=(14))
        username.grid(row=0, column=1)
        password = ttk.Entry(Form, textvariable=PASSWORD, show="*", font=(14))
        password.grid(row=1, column=1)



        # ==============================BUTTON WIDGETS=================================
        btn_login = Button(Form, text="Login", font=('arial', 10, "bold"),width=45,height=2, relief = RIDGE, command=lambda:command1())
